 ...
 *
 */
class TipPridelaveController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController {
	...
	public function listAction() {
		$tipPridelaves = $this->tipPridelaveRepository->findAll();
		$this->view->assign('tipPridelaves', $tipPridelaves);
	}
