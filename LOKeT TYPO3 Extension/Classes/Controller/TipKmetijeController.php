 ...
 *
 */
class TipKmetijeController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController {
	...
	public function listAction() {
		$tipKmetijes = $this->tipKmetijeRepository->findAll();
		$this->view->assign('tipKmetijes', $tipKmetijes);
	}
